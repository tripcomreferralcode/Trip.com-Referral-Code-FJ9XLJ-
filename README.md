...
The referral code is for new user sign-up and first booking discount.
The same or another reward goes to the referring existing user.
...
**Wide applicability:** Works for hotels, flights and possibly combined travel bookings.

**More deals:** Trip.com regularly has additional promotion codes, and the referral discount adds on top.

**Ease of use:** Just paste the code when signing up or during booking and the system recognises it.
...
Newer users often unlock app-only deals or mobile savings.
...
Visit Trip.com (or download the Trip.com mobile app).

Sign up for a new account (as a new user).

During registration or at checkout, look for the field labelled “Referral Code”, “Promo Code”, “Invite Code” etc.

Enter FJ9XLJ in that field.

Browse and select your booking (hotel, flight, or travel package).

At payment/checkout stage, ensure the discount of ~10% is applied.

Finalise payment and keep records (booking confirmation, code used, discount shown).
...
Confirm that the discount amount shows up in the booking summary.

Ensure you meet any minimum spend, booking category or region eligibility (if applicable).

Check if the referral discount is valid only for “first booking” / “new users” etc.

Switch currency to your local (₹ INR for India) to check exact discount value and whether it applies in your region.
...
Using it with an existing account (won’t qualify as “new user”).

Ignoring terms such as “cannot be used with other promos”.
...
**Valid booking types:** Hotel bookings? Flights? Both? Some codes restrict one.

**Minimum spend:** There might be a minimum booking value.

**Regions/Markets:** Discounts may be valid only in certain countries or regions.

**Expiry date:** The code may expire on a specified date.

**Non-stackable:** You may not combine it with other promo codes or site-wide discounts.

**Refund/cancellation policy:** If you cancel or change booking, discount may be void.
...
The referrer gets Trip Coins or credit after the friend completes travel. Trip.com
...
The discount reflected in the payment summary.
...
Wait for a seasonal sale on the destination you’re interested in.

Use the referral discount + sale price.

Pay attention to cancellation/change policies (sometimes cheaper bookings are less flexible).

Book flights and hotels together if possible (package deals sometimes cheaper).
...
Let’s assume a hotel in Bali (4 nights) has a base fare of ₹12,000 on Trip.com before any discounts.

You sign up as new user, enter referral code FJ9XLJ.

The 10% discount is applied → you save ₹1,200 → effective booking cost becomes ₹10,800.

Simultaneously you check if there’s a “flash hotel deal – 20% off” on Trip.com for Bali. Suppose there is. You apply both (if stacking allowed) or the system automatically picks the better discount.

Booking final cost: maybe ₹9,000 (after stacking/referral) instead of ₹12,000.

You make payment and save the booking confirmation.

Later you write a review (if required) to earn Trip Coins for your next trip.
...
A: Usually not. Referral codes are typically meant for new users or first-time bookings. If you already have an account, the code may be invalid.
Q3: Does the 10% discount apply to flights and hotels both?
A: Generally yes, but it depends on the terms for that particular referral or region. Always confirm at checkout that the discount is applied for your booking type.
Q4: Can I combine the referral code with other promo codes?
A: Sometimes yes, sometimes no. Many deals specify “cannot be combined with other offers”. At checkout, the system may automatically apply the best one. Check terms.
Q5: What happens if I cancel my booking?
A: If you cancel or change your booking, the discount may be void or you may lose part of it. Always check the cancellation policy and whether the discount still stands in changed circumstances.
...
If the code isn’t applied properly, you may pay full price. Always verify.

Some bookings (e.g., flexible fares, certain hotels) may restrict promo code use.

Region-specific terms: The code may not work in India (Haryana/Faridabad region) if the promotion is for other markets. Always test.

The listed “10% off” might be a best-case or approximate. Real discount may differ.
...
It offers booking of flights, hotels, train tickets, car rentals, airport transfers across many countries.
It has a proper referral/invite program (see Invite & Earn pages) which shows transparency about how the referral discounts and Trip Coins work.
It is frequently featured in deal-site aggregators, with many promotional offers.
